...
const Tasks = props => {
  ...
  const it = items.filter(
    item => item.important === false && item.complete === false
  );
  ...
  const onSubmitCompleted = async data => {
    data.complete = true;
    new axios.put('http://localhost:8080/update/' + data.id, data);
  ...
  return (
    <Container my={2} maxW="100%">
            ...
            <h2>
              ...
              >
                ...
                >
                  ...
                  <Text color="red">{item.mark}</Text>
                </Flex>
              </AccordionButton>
            </h2>

            <AccordionPanel key={item.id} pb={4}>
                      ...
                      <AlertDialogOverlay>
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <Button
                              colorScheme="green"
                              onClick={() => onSubmitCompleted(item)}
                              ml={3}
                            >
                              Completed
                            </Button>
      ...
      <Flex justifyContent="center" my={10}>
        <Box as="a" w="100">
          <DrawerExample text={{ str: 'Task', type: false }} />
        </Box>
      </Flex>
    </Container>
  );
